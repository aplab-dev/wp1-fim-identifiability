...
revision_history:
  ...
  - v9 (2026-05-26): arXiv-submission revision. Added pre-submission fact-check note in §Acknowledgments (Strobl outreach on 2026-05-17, no reply received in 9-day window — author accepts sole responsibility for attribution accuracy). No content/methodology changes; this is the submitted-to-arXiv version.
...
**Headline real-data finding** (full 72-patient cohort, 71 evaluated successfully, see `results/figures/fig19_real_cohort_pa_vs_pe_*.png`):
...
This work is part of an open-source independent research project on adaptive cancer therapy. Special thanks to the authors of Brady-Nicholls 2020, Strobl 2022, Gallagher 2025, Zhang 2017, and Cunningham 2020 for their foundational empirical and theoretical contributions; to the maintainers of `scipy`, `numpy`, `matplotlib`, `numpyro`, and `diffrax` for the underlying computational stack.

Pre-submission fact-check was solicited from M. Strobl (Cleveland Clinic) on the cohort-specific Strobl 2022 numbers cited in §6.7 and §6.9; no reply was received in the submission window. The author is solely responsible for any remaining errors of attribution or characterization.
