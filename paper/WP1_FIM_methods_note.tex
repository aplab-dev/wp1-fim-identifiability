...
\date{\today \\ \textit{v9 — arXiv submission}}
...
Pre-submission fact-check was solicited from M.~Strobl (Cleveland Clinic) on
the cohort-specific Strobl 2022 numbers cited in Sections~\ref{sec:cohort_mcmc}
and \ref{sec:real_data}; no reply was received in the submission window. The
author is solely responsible for any remaining errors of attribution or
characterization.
